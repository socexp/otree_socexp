...
class Constants(BaseConstants):
    name_in_url = 'public_goods_quiz'
    players_per_group = None
    instructions_template = 'public_goods_quiz/Instructions.html'
    instructions_template2 = 'public_goods_quiz/Instructions2.html'
    with open('public_goods_quiz/quiz.csv',encoding = "utf-8") as questions_file:
